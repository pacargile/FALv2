            ...
            for ii,atm_i in enumerate(self.atmflist):
                ...
                if 'isofrac' in self.specinfo[ii].keys():
                    ...
                    for kk in self.specinfo[ii]['isofrac'].keys():
                        ...
                        synout_i['loggf'][cond1_atm] = float('{0:.3f}'.format(synout_i["loggf"][cond1_atm] - corr1))
                        synout_i['loggf'][cond2_atm] = float('{0:.3f}'.format(synout_i["loggf"][cond2_atm] - corr2))
                        ...
                        synout_i['loggf'][cond1_mol_1] = float('{0:.3f}'.format(synout_i["loggf"][cond1_mol_1] - corr1))
                        synout_i['loggf'][cond2_mol_1] = float('{0:.3f}'.format(synout_i["loggf"][cond2_mol_1] - corr2))
                        synout_i['loggf'][cond1_mol_2] = float('{0:.3f}'.format(synout_i["loggf"][cond1_mol_2] - corr1))
                        synout_i['loggf'][cond2_mol_2] = float('{0:.3f}'.format(synout_i["loggf"][cond2_mol_2] - corr2))
