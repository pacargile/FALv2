...
class AdjKurucz(object):
    ...
    def adjwl(self,linind,dwl,fort=None):
        ...
        if fort == 12:
            ...
            self.RK.f12in['nbuff'] = self.RK.f12in['nbuff'].at[linind].set(nbuff)
            self.RK.f14in['wl'] = self.RK.f14in['wl'].at[linind].set(self.RK.f14in['wl'][linind] + dwl)
            self.RK.f14in['wlvac'] = self.RK.f14in['wlvac'].at[linind].set(self.RK.f14in['wlvac'][linind] + dwl)

            self.RK.f14in['dwl'] = self.RK.f14in['dwl'].at[linind].set(dwl)
        ...
        if fort == 19:
            ...
            self.RK.f19in['nbuff'] = self.RK.f19in['nbuff'].at[linind].set(nbuff)
            self.RK.f19in['wlvac'] = self.RK.f19in['wlvac'].at[linind].set(self.RK.f19in['wlvac'][linind] + dwl)
            self.RK.f20in['wl'] = self.RK.f20in['wl'].at[linind].set(self.RK.f20in['wl'][linind] + dwl)
            self.RK.f20in['wlvac'] = self.RK.f20in['wlvac'].at[linind].set(self.RK.f20in['wlvac'][linind] + dwl)

            self.RK.f20in['dwl'] = self.RK.f20in['dwl'].at[linind].set(dwl)
    ...
    def adjloggf(self,linind,dloggf,fort=None):
        ...
        if fort == 12:
            ...
            self.RK.f12in['cgf'] = self.RK.f12in['cgf'].at[linind].set(self.RK.f12in['cgf'][linind] * dgf)

            self.RK.f14in['gf']     = self.RK.f14in['gf'].at[linind].set(self.RK.f14in['gf'][linind] * dgf)
            self.RK.f14in['gflog']  = self.RK.f14in['gflog'].at[linind].set(self.RK.f14in['gflog'][linind] + dloggf)
            self.RK.f14in['dgflog'] = self.RK.f14in['dgflog'].at[linind].set(dloggf)
        ...
        if fort == 19:
            ...
            self.RK.f19in['gf'] = self.RK.f19in['gf'].at[linind].set(self.RK.f10in['gf'][linind] * dgf)

            self.RK.f20in['gf']     = self.RK.f20in['gf'].at[linind].set(self.RK.f20in['gf'][linind] * dgf)
            self.RK.f20in['gflog']  = self.RK.f20in['gflog'].at[linind].set(self.RK.f20in['gflog'][linind] + dloggf)
            self.RK.f20in['dgflog'] = self.RK.f20in['dgflog'].at[linind].set(dloggf)
    ...
    def adjgammas(self,linind,dgammas,fort=None):
        ...
        if fort == 19:
            ...
            self.RK.f20in['dgammas'] = self.RK.f20in['dgammas'].at[linind].set(dgammas)
    ...
    def adjgammar(self,linind,dgammar,fort=None):
        ...
        if fort == 19:
            ...
            self.RK.f20in['dgammar'] = self.RK.f20in['dgammar'].at[linind].set(dgammar)
