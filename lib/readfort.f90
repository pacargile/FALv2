...
100     continue
    ...
    subroutine readfile19(&
        ...
        do while (1.eq.1)
            ...
            WRITE(6,*) I,WLVAC,ELO,GF,NBLO,NBUP,NELION,TYPE,NCON,NELIONX,GAMMAR,GAMMAS,GAMMAW,NBUFF,LIM
            WLVACi(I) = WLVAC
            ELOi(I) = ELO
            GFi(I) = GF
            NBLOi(I) = NBLO
...
100     continue
    ...
    subroutine writefile19(&
        ...
        do I=1,NLINESi
            ...
            NBUFF = NBUFFi(I)
            LIM = LIMi(I)
            ! WRITE(6,*)WLVAC,ELO,GF,NBLO,NBUP,NELION,TYPE,NCON,NELIONX,GAMMAR,GAMMAS,GAMMAW,NBUFF,LIM
