...
C
      ILINE = ILINE + 1
      IF(ILINE.EQ.1) THEN
      WRITE(6,*) 'FIRST WL WRITTEN:'
      WRITE(6,*) WL,DWL,GFLOG,DGFLOG,CODE,E,XJ,LABEL,
     1 EP,XJP,LABELP,GR,DGAMMAR,GS,DGAMMAS,GW,DGAMMAW,WAVENO,
     2 REF,NBLO,NBUP,ISO1,X1,ISO2,X2,OTHER1,OTHER2,ISOSHIFT,NELION
      ENDIF
...
C    unlog the shifted values
     ...
     1 EP,XJP,LABELP,GR,DGAMMAR,GS,DGAMMAS,GW,DGAMMAW,WAVENO,
     2 REF,NBLO,NBUP,ISO1,X1,ISO2,X2,OTHER1,OTHER2,ISOSHIFT,NELION,
     3 ISHIFT,ISHIFTP,IXFIXFP,LINESIZE,AUTO

  144 FORMAT(F11.4,F7.4,2F7.3,F8.2,F12.3,F5.1,1X,A8,A2,
     1        F12.3,F5.1,1X,A8,A2,6F6.2,F11.3,
     2        1X,A4,I2,I2,I3,F6.3,I3,F6.3,A8,A2,A8,A2,I6,I4,2X,f8.4)
      ENDIF
...
C   144 FORMAT(F11.4,F7.3,F8.2,F12.3,F5.1,1X,A8,A2,F12.3,F5.1,1X,A8,A2,
C      1 F6.2,F6.2,F6.2,A4,I2,I2,I3,F7.3,I3,F7.3,A8,A2,A8,A2)
...
C      IF(IFNLTE.EQ.1)N19=0
     ...
     1     WLBEG,WLEND,RESOLU,RATIO,RATIOLG,CUTOFF,LINOUT
      CLOSE(UNIT=93)
      WRITE(6,*)"OUTPUT UNIT-93: ,NLINES,LENGTH,IFVAC,
