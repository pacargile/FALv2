...
C      WRITE(6,140)WL,GFLOG,CODE,E,XJ,LABEL,
C     1 EP,XJP,LABELP,GR,GS,GW,WAVENO,
C     2 REF,NBLO,NBUP,ISO1,X1,ISO2,X2,OTHER1,OTHER2,ISOSHIFT,NELION
...
C
cC     14NOV13   Stark width GS is sometimes too large for high series members       
c      IF(GS.NE.0.)GS=MIN(GS,-3.)
c     17Jun15    This was a mistake.  The lines are supposed to smear out and 
c     merge at high Ne.
C
...
!       WRITE(6,*)WLVAC,ELO,GF,NBLO,NBUP,NELION,TYPE,NCON,NELIONX,
!      1GAMMAR,GAMMAS,GAMMAW,NBUFF,LIM
      IF(LINOUT.GE.0)WRITE(20)LINDAT8,LINDAT4
      ! IF(LINOUT.GE.0)WRITE(6,*)LINDAT8,LINDAT4
      N19=N19+1
C      WRITE(6,*)WLVAC,gammar
C     WRITE(6,5555)WLVAC,ILINE
 5555 FORMAT(112X,F10.4,I10)
      GO TO 900
C     PLAIN LINE
 1260 WRITE(12)NBUFF,CGF,NELION,ELO,GAMMAR,GAMMAS,GAMMAW
C      IF(JJ.LT.5)WRITE(6,*)NBUFF,CGF,NELION,ELO,GAMMAR,GAMMAS,GAMMAW
      IF(JJ.LT.5)WRITE(6,*)NBUFF,CODE,WLVAC
      JJ = JJ + 1
