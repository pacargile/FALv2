...
!      1           MAXBUFF=MAXLEN+MAXPROF,MAXLIN=MAXBUFF+MAXPROF*2)
      PARAMETER (LENREC=1000,MAXLEN=10001,MAXPROF=2500,
     1           MAXBUFF=MAXLEN+MAXPROF,MAXLIN=MAXBUFF+MAXPROF*2)
!       PARAMETER (LENREC=1000,MAXLEN=1000001,MAXPROF=5000,
!      1           MAXBUFF=MAXLEN+MAXPROF,MAXLIN=MAXBUFF+MAXPROF*2)
 ...
 3440 WRITE(13)LINDAT8,LINDAT4
      ...
      DO 3441 I=1,NLINES
            ...
            IF(NISOFRAC.GT.0)THEN
                  ...
                  CORR1 = DLOG10(DBLE(1.0)+(DBLE(1.0)/DBLE(ISOFRACSOL)))
     1                  -DLOG10(DBLE(1.0)+(DBLE(1.0)/DBLE(ISOFRACSTAR)))
                  CORR2 = DLOG10(DBLE(1.0)+DBLE(ISOFRACSOL))
     1                  -DLOG10(DBLE(1.0)+DBLE(ISOFRACSTAR))
                  IF(I.EQ.1)THEN
...
!      IF(J.EQ.1)THEN
!        IF(ILINE.GT.(NLINES-100))THEN
!          IF(KAPPA0.LT.KAPMIN)THEN
!            WRITE(6,*)'KAPPA0 < KAPMIN',NBUFF,KAPMIN,CUTOFF
!          ENDIF
!        ENDIF
!      ENDIF
...
C     DIRECT IO TRANSPOSITION
      ...
      IREC=IREC+1
      NEND=NBEG+LENREC-1
      WRITE(41,REC=IREC)(BUFFER(I),I=NBEG,NEND)
   26 CONTINUE
...
C     DIRECT IO TRANSPOSITION
      ...
      READ(41,REC=IREC)(TRANSP(J,I),I=1,LENREC)
   93 CONTINUE
      NOUT=LENREC
